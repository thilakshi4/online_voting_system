...
function checkForm(form)
{
    ...
    function reload1(form)
    {
        ...
        var val_password = form.password.value;
        var val = form.province.options[form.province.options.selectedIndex].value;
        self.location = 'officer_register_voters.php?province=' + val + '&nic=' + val_nic + '&full_name=' + val_fullname
    ...
    function reload3(form)
    {
        ...
        self.location = 'officer_register_voters.php?province=' + val + '&district=' + val2
