    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <div ><a class="navbar-brand" href="officers_Login.php.">&nbsp;&nbsp;Back</a></div>
            </li>   
        </ul>
    </div>
</nav>
...
function reset_password() {
    ...
    $sql = "SELECT * FROM staff_login WHERE BINARY username='$username' AND mobile_no='$mobile'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($row['username'] == $username && $row['mobile_no'] == $mobile) {
            ...
            $sql_update = "UPDATE staff_login SET password='$password' WHERE username='$username' AND mobile_no='$mobile'";
            ...
            if (mysqli_query($GLOBALS['conn'], $sql_update)) {
                ...
                . 'type: "success"}, '
                . 'function() { window.location = "officers_Login.php";});}, 500);</script>';
            }
        }
    } else {
