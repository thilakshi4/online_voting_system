...
$pdf->Cell(10);
$pdf->Cell(70, 10, 'District', 1, 0, 'C', true);
...
while ($row = mysqli_fetch_array($result)) {
    $pdf->Cell(10);
    $pdf->Cell(70, 5, $row["e_district"], 1, 0, 'C');
    $pdf->Cell(50, 5, $row["no_of_registered_voters"], 1, 0, 'C');
    $pdf->Cell(50, 5, $row["no_of_votes"], 1, 1, 'C');
}


$query_sum = "SELECT SUM(counts) AS vote_count FROM  v_district_vote_count";
...
$pdf->AddPage();
$pdf->Ln(10);
$query_s = "SELECT url FROM image_url WHERE id=2";
