...
<br>
<?php
$result = mysqli_query($conn, "SELECT * FROM candidate_requests ORDER BY ref_number");
?>
<div align="center" class="style_form">
    <form action = "" method = "post">
        <table border="1" id="table" style="width:98%; font-weight: 800">
            <tr>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM candidate_requests WHERE ref_number='$referenceNumber'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<script> window.location.assign('view_candidate_register__request.php'); </script>";
        }
    }
    ?> 
