...
$pdf->Cell(155, 20, 'Presidential Election 2021 Vote Distribution - Polling Division', 0, 1, 'C', true);
...
$pdf->Cell(10);
$pdf->Cell(70, 10, 'Polling Division', 1, 0, 'C', true);
...
while ($row = mysqli_fetch_array($result)) {
    $pdf->Cell(10);
    $pdf->Cell(70, 5, $row["p_division"], 1, 0, 'C');
    $pdf->Cell(50, 5, $row["no_of_registered_voters"], 1, 0, 'C');
    $pdf->Cell(50, 5, $row["no_of_votes"], 1, 1, 'C');
}


$query_sum = "SELECT SUM(counts) AS vote_count FROM  p_division_vote_count";
...
$pdf->AddPage();
$pdf->Ln(10);
$query_s = "SELECT url FROM image_url WHERE id=4";
