...
<nav class="navbar navbar-expand-sm navbar navbar-dark bg-primary">
    ...
    <div>
        <form action="vote_precentage_province_2021_report.php" method = "post">
...
<div class="container text-center home_box col-sm-10">
    <div align="center">
        ...
        <br>
        <?php
        $stmt = $conn->query("select province,no_of_registered_voters,no_of_votes,concat(ROUND(((no_of_votes/no_of_registered_voters)*100),1),'%') AS percentage FROM v_province_pvn GROUP BY `province`");
        $query = "select province,no_of_registered_voters,no_of_votes,ROUND(((no_of_votes/no_of_registered_voters)*100),1) AS percentage FROM v_province_pvn GROUP BY `province`";
...
// create PHP array
    ...
    <tr> <th>Province</th><th>Number of Registered Voters</th><th>Vote Count</th><th>Vote Percentage</th></tr>";
