...
<br>
<?php
$result = mysqli_query($conn, "SELECT * FROM req_reg_officer");
?>
<div align="center" class="style_form ">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM req_reg_officer WHERE ref_number='$referenceNumber'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<script> window.location.assign('view_ec_request.php'); </script>";
        }
    }
    ?> 
