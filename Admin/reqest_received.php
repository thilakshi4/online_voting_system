...
<nav class="navbar navbar-expand-sm navbar navbar-dark bg-primary">
    ...
    <div ><a class="navbar-brand" href="reqest_received.php."><i class="fa fa-refresh" aria-hidden="true"></i></a></div>
...
if (isset($_POST['btn_search'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM requst_all WHERE ref_number='$ref_number'");
} else {
    $result = mysqli_query($conn, "SELECT * FROM requst_all");
}
?>
