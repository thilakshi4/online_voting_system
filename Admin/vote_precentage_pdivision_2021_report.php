...
$query = "select p_division,no_of_registered_voters,no_of_votes,concat(ROUND(((no_of_votes/no_of_registered_voters)*100),1),'%') AS percentage FROM v_polling_division_pvn GROUP BY `p_division` ";
...
$pdf->Cell(5);
$pdf->Cell(60, 10, 'Polling Division', 1, 0, 'C', true);
...
while ($row = mysqli_fetch_array($result)) {
    $pdf->Cell(5);
    $pdf->Cell(60, 5, $row["p_division"], 1, 0, 'C');
