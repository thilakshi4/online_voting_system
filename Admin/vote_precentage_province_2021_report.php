...
$query = "select province,no_of_registered_voters,no_of_votes,concat(ROUND(((no_of_votes/no_of_registered_voters)*100),1),'%') AS percentage FROM v_province_pvn GROUP BY `province` ";
...
$pdf->Cell(5);
$pdf->Cell(60, 10, 'Province', 1, 0, 'C', true);
...
while ($row = mysqli_fetch_array($result)) {
    $pdf->Cell(5);
    $pdf->Cell(60, 5, $row["province"], 1, 0, 'C');
