...
<nav class="navbar navbar-expand-sm navbar navbar-dark bg-primary">
    ...
    <div ><a class="navbar-brand" href="reqest_received_staff.php."><i class="fa fa-refresh" aria-hidden="true"></i></a></div>
...
if (isset($_POST['btn_search'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM requst_staff WHERE ref_number='$ref_number'");
} else {
    $result = mysqli_query($conn, "SELECT * FROM requst_staff");
}
?>
...
<div align="center" class="style_form ">
    ...
    <form action = "" method = "post">
        <table border="1" id="table" style="width:50%">
            <tr>
                <td colspan="2">
                    <h1 class="py-2 bg-success text-white rounded"><i class="fa fa-users" aria-hidden="true">&nbsp;</i>Staff Requests</h2>
                </td>
            </tr>
            <tr>
